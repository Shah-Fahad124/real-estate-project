...
<div class="app-content">
    <section class="section">
        ...
        <div class="page-header p-5" style="background: linear-gradient(to bottom right, #7673e6, #8483f5);">
            <h4 class="page-title font-weight-bold">Developer Form</h4>
        </div>
        ...
        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12" >
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h4 class="font-weight-bold">Add Developer</h4>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="./process/add-developer-process.php" method="POST" enctype="multipart/form-data">
                        <div class="row">
                            <!-- Developer Name -->
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <input class="form-control form-control-lg" type="file" name="logo" accept="image/*" required>
                            </div>
                        </div>
                        <!-- Description -->
